...
from snr_calculator.genconutils.genprocess import GenProcess
...
def generate_contour_data(pid):
    ...
    #read out
    file_out = FileReadOut(pid, pid['output_info']['output_file_type'], WORKING_DIRECTORY + '/' + pid['output_info']['output_file_name'],  running_process.xvals, running_process.yvals, running_process.final_dict, running_process.num_x, running_process.num_y)
